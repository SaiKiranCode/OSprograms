...
bool SafetyAlgorithm(vector<vector<int>> AllocatedResources, vector<vector<int>> MaxResource,
 vector<vector<int>> NeedResources, vector<int> AvailableResources, vector<int> &SafeSequence, 
 const int noOfProcesses, const int noOfResources)
{
...
int main()
{
    ...
    bool isSafe = SafetyAlgorithm(AllocatedResources, MaxResource, NeedResources, 
        AvailableResources, SafeSequence, noOfProcesses, noOfResources);
